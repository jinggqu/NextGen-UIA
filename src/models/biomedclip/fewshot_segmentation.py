"""
Few-shot Segmentation with BiomedCLIP
...
def get_args():
    ...
    parser = argparse.ArgumentParser("Few-shot Segmentation with BiomedCLIP")

    # Data related
    parser.add_argument("--exp", type=str, default="fewshot_seg")
...
def train(args):
    ...
    writer.close()
    return "Few-shot Segmentation Training Finished!"
