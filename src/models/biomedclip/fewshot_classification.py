"""
Few-shot Classification with BiomedCLIP

This script performs classification with limited training data to evaluate
the data efficiency of different adaptation methods (Baseline, LoRA, MONA).
"""
...
def get_args():
    ...
    parser = argparse.ArgumentParser("Few-shot Classification with BiomedCLIP")

    # Data related
    parser.add_argument("--exp", type=str, default="fewshot_cls")
...
def train(args):
    ...
    logging.info("Start few-shot training")
    ...
    writer.close()
    return "Few-shot Classification Training Finished!"
