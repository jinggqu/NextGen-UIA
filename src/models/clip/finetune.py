"""
CLIP Fine-tuning with Frequency-Enhanced MONA and Loss Comparison
"""
...
def get_args():
    ...
    parser = argparse.ArgumentParser("CLIP Fine-tuning with MONA adapters and MoHN Loss")
    ...
    parser.add_argument("--exp", type=str, default="clip_finetune")
...
def prepare_model(args):
    """Load CLIP and inject MONA adapters"""
    # Load CLIP model
    ...
    model, mona_count = inject_mona_variant_to_clip(
...
def train(args):
    ...
    for epoch_num in tqdm(range(max_epoch), ncols=70):
        ...
        for sampled_batch in trainloader:
            ...
            # Tokenize texts
            text_tokens = clip.tokenize(texts, truncate=True).to(args.device)
