"""
MetaCLIP Fine-tuning with Frequency-Enhanced MONA and Loss Comparison
"""
...
def get_args():
    ...
    parser = argparse.ArgumentParser("MetaCLIP Fine-tuning with Frequency-Enhanced MONA")
    ...
    # Model related
    parser.add_argument("--exp", type=str, default="metaclip_finetune")
    ...
    parser.add_argument(
        "--uniformity_weight", type=float, default=0, help="Uniformity regularization weight for MoHN loss (0=disabled)"
    )
...
def prepare_model(args):
    ...
    model, _ = create_model_from_pretrained("hf-hub:timm/vit_base_patch16_clip_224.metaclip_400m", cache_dir="./ckpt")
    tokenizer = get_tokenizer("hf-hub:timm/vit_base_patch16_clip_224.metaclip_400m")
...
def train(args):
    """Train MetaCLIP with MONA adapters and MoHN loss"""
    logging.info("=" * 50)
